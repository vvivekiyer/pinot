 ...
 * the exponential weighted moving average (EWMA) of query latencies seen by the server. The EMWA latencies are
...
public class LatencySelector implements AdaptiveServerSelector {
  ...
  public List<Pair<String, Double>> fetchServerRankingWithValues() {
    List<Pair<String, Double>> pairList = _serverRoutingStatsManager.fetchServerLatency();
