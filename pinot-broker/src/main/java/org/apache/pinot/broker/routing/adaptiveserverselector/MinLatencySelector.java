...
public class MinLatencySelector implements AdaptiveServerSelector {
  private final ServerRoutingStatsManager _serverRoutingStatsManager;
  private final Random _random;

  public MinLatencySelector(ServerRoutingStatsManager serverRoutingStatsManager) {
  ...
  public String select(List<String> serverCandidates) {
    ...
    for (String server : serverCandidates) {
      Double latency = _serverRoutingStatsManager.fetchServerLatency(server);
  ...
  public List<Pair<String, Double>> fetchServerRanking() {
    ...
    pairList = _serverRoutingStatsManager.fetchServerLatency();
