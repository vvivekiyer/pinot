...
public class AggregationFunctionFactoryTest {
  ...
  public void testGetAggregationFunction() {
    ...
    AggregationFunction aggregationFunction =
        AggregationFunctionFactory.getAggregationFunction(function, new AggFunctionQueryContextContext());
    ...
    aggregationFunction = AggregationFunctionFactory.getAggregationFunction(function, new AggFunctionQueryContextContext());
  ...
  public void testAggregationFunctionWithMultipleArgs() {
    ...
    AggregationFunction aggregationFunction =
        AggregationFunctionFactory.getAggregationFunction(queryContext.getSelectExpressions().get(0).getFunction(),
            new AggFunctionQueryContextContext());
