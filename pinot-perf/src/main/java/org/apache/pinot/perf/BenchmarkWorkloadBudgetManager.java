...
public class BenchmarkWorkloadBudgetManager {
  ...
  @Benchmark
  @Threads(1)
  public WorkloadBudgetManager.BudgetStats tryCharge_1Thread(BenchmarkState state) {
    return state.manager().tryCharge(BenchmarkState.WORKLOAD, BenchmarkState.CPU, BenchmarkState.MEM);
  }

  @Benchmark
  @Threads(10)
  public WorkloadBudgetManager.BudgetStats tryCharge_10Threads(BenchmarkState state) {
    return state.manager().tryCharge(BenchmarkState.WORKLOAD, BenchmarkState.CPU, BenchmarkState.MEM);
  }

  @Benchmark
  @Threads(20)
  public WorkloadBudgetManager.BudgetStats tryCharge_20Threads(BenchmarkState state) {
    return state.manager().tryCharge(BenchmarkState.WORKLOAD, BenchmarkState.CPU, BenchmarkState.MEM);
  }

  @Benchmark
  @Threads(40)
  public WorkloadBudgetManager.BudgetStats tryCharge_40Threads(BenchmarkState state) {
    return state.manager().tryCharge(BenchmarkState.WORKLOAD, BenchmarkState.CPU, BenchmarkState.MEM);
  }
}
